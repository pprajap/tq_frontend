            ...
            Column {
                ...
                Row {
                    ...
                    CheckBox {
                        ...
                        spacing: 30
                        contentItem: Text {
                            text: isFuncCheck.text
                            color: "#ffffff"
                            font.pixelSize: isFuncCheck.font.pixelSize
                            font.bold: isFuncCheck.font.bold
                        }
                    }
                    CheckBox {
                        id: isVectCheck
                        ...
                        spacing: 30
                        contentItem: Text {
                            text: isVectCheck.text
                            color: "#ffffff"
                            font.pixelSize: isVectCheck.font.pixelSize
                            font.bold: isVectCheck.font.bold
                        }
                    }
                    CheckBox {
                        id: withCacheCheck
                        ...
                        spacing: 30
                        contentItem: Text {
                            text: withCacheCheck.text
                            color: "#ffffff"
                            font.pixelSize: withCacheCheck.font.pixelSize
                            font.bold: withCacheCheck.font.bold
                        }
                    }
                }
                Row {
                    ...
                    CheckBox {
                        ...
                        spacing: 30
                        contentItem: Text {
                            text: withLogCheck.text
                            color: "#ffffff"
                            font.pixelSize: withLogCheck.font.pixelSize
                            font.bold: withLogCheck.font.bold
                        }
                    }
                    CheckBox {
                        id: withOptCheck
                        ...
                        spacing: 30
                        contentItem: Text {
                            text: withOptCheck.text
                            color: "#ffffff"
                            font.pixelSize: withOptCheck.font.pixelSize
                            font.bold: withOptCheck.font.bold
                        }
                    }
                }
                Row {
